						...
						<!-- recorremos todos los objetos de la coleccion cursos 
							...
							<li id = "oferta-ejemplo${curso.ID_curso}">
								<div class = "ofertas-descripcion">
									...
									<c:otherwise>
									<p class="error">El curso ${curso.DES_titulo } esta pendiente de validacion</p>
									</c:otherwise>
								</c:choose>
				...
				<div id = "seguidores">
						...
						<c:choose>
								...
								<c:when test="${curso.TIPO_destacado == 1 }">
									...
									<p class = "seguidores-info"><a style="color:black" href="contenidoCursos?nombreCurso=${curso.DES_titulo }">${curso.DES_titulo }</a></p>
								</c:when>
